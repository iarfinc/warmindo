...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Alamat Kamu</h3>
      <input type="text" class="box" placeholder="No. Jalan" required maxlength="50" name="flat">
      <input type="text" class="box" placeholder="No. Rumah" required maxlength="50" name="building">
      <input type="text" class="box" placeholder="Kelurahan/Desa" required maxlength="50" name="area">
      <input type="text" class="box" placeholder="Kecamatan" required maxlength="50" name="town">
      <input type="text" class="box" placeholder="Kota/Kabupaten" required maxlength="50" name="city">
