...
<div class="heading">
   <h3>Order</h3>
   <p><a href="html.php">Home</a> <span> / Order</span></p>
</div>

<section class="orders">

   <h1 class="title">Orderan Kamu</h1>
   ...
   ?>
   <div class="box">
      <p>Disimpan pada : <span><?= $fetch_orders['placed_on']; ?></span></p>
      ...
      <p>Orderan Kamu : <span><?= $fetch_orders['total_products']; ?></span></p>
   ...
   <?php
         ...
         echo '<p class="empty">Tidak ada order yang disimpan!</p>';
      }
      }
   ?>
